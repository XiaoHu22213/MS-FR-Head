...
if __name__ == "__main__":
    ...
    r1 = "infogcn(FR_Head)/weight/1"
    r2 = "infogcn(FR_Head)/weight/2"
    r3 = "infogcn(FR_Head)/weight/3"
    r4 = "infogcn(FR_Head)/weight/4"
    r5 = "infogcn(FR_Head)/weight/5"
    r6 = "infogcn(FR_Head)/weight/6"
    r7 = "infogcn(FR_Head)/weight/7"
    r8 = "infogcn(FR_Head)/weight/8"
    r9 = "infogcn(FR_Head)/weight/9"

    sr1 = "SNC-CTR-GCN/weight/v2/joint"
    sr2 = "SNC-CTR-GCN/weight/v2/joint-SNC"
    sr3 = "SNC-CTR-GCN/weight/v2/bone"
    sr4 = "SNC-CTR-GCN/weight/v2/bone-SNC"
    sr5 = "SNC-CTR-GCN/weight/v2/motion"
    sr6 = "SNC-CTR-GCN/weight/v2/motion-SNC"

    with open('data/test_label_B.npy', 'rb') as f:
        label = np.load(f)
    ...
    alpha2 = [1,1,1,1,2.5,2]
    #alpha2 = [0.7,0.7,0.7,0.6,0.4,0.4]
