...
class Processor():
    ...
    def load_data(self):
        ...
        label_path = self.arg.label_path
        test_data = self.arg.test_data
        test_label = self.arg.test_label
    ...
    def load_model(self):
        ...
        if self.arg.focal_loss:
            self.loss = MultiClassFocalLossWithAlpha(num_class=self.arg.num_class)
        else:
